...
set project_path=/Users/gxy/Desktop/guoxyu/01-test/01_xtsCode/master-xts/xts/commonlibrary/crossplatform/arraylisttest
set ohpm_path=/Users/gxy/ohpm/ohpm-1.2.5/bin/ohpm
set arkuiXSdkPath=/Users/gxy/Desktop/guoxyu/Ark-X_SDK/14/arkui-x
