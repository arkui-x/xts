...
set project_path=C:/Users/ADMINI~1/AppData/Local/Temp/aceProject/codeparsingtest
set ohpm_path=C:\Users\Administrator\ohpm\bin\ohpm
set arkuiXSdkPath=D:\arkui-x\23\arkui-x
