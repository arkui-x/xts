...
set project_path=E:\commonlibrarytest
set ohpm_path=D:\Program Files\DevEco Studio-6.0.0.848\DevEco Studio\tools\ohpm\bin\ohpm
set arkuiXSdkPath=D:\ArkUI-X\Sdk\20\arkui-x
