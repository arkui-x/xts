...
set project_path=D:\Projects\ArkUI-X_Project\LocalStore\arkuix_xts\communication\communicationconstanttest
set ohpm_path=D:\Deveco\DevEco_Studio\tools\ohpm\bin\ohpm
set arkuiXSdkPath=D:\Projects\Tools\ArkUI-X\SDK\20\arkui-x
