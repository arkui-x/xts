...
set project_path=C:/Users/WANGZU~1/AppData/Local/Temp/aceProject/Filepickerxts
set ohpm_path=D:\tool\Ohpm\bin\ohpm
set arkuiXSdkPath=D:\tool\ArkuiX_SDK\11\arkui-x
