...
set project_path=C:\Users\Administrator\Desktop\xr\global
set ohpm_path=D:\Devecoexe\DevEcoStudioArkuix\DevEco_Studio\tools\ohpm\bin\ohpm
set arkuiXSdkPath=D:\11Arkui-x\ArkUI-x\21\arkui-x
