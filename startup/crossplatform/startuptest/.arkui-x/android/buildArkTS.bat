...
set project_path=C:\Users\Administrator\Desktop\code1020\startuptest
set ohpm_path=D:\DevEcoArkui\DevEcoStudio\tools\ohpm\bin\ohpm
set arkuiXSdkPath=D:\ArkUI-x-sdk\21\arkui-x
