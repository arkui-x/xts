...
set project_path=C:/Users/ADMINI~1/AppData/Local/Temp/aceProject/bundleManager
set ohpm_path=C:\Users\Administrator\ohpm\ohpm-1.4.0\bin\ohpm
set arkuiXSdkPath=D:\advelop\ArkUI-X\Sdk\15\arkui-x
