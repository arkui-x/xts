...
set project_path=C:/Users/BWX141~1/AppData/Local/Temp/aceProject/testRelationalStore2
set ohpm_path=D:\devecostudio\DevEcoStudio\tools\ohpm\bin\ohpm
set arkuiXSdkPath=D:\devoecoConfigure\arkui_sdk\14\arkui-x
